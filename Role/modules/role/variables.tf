...
variable "aws_iam_role_policy_node_policy" {
  description = "ARN of the EKS worker node policy to attach to the IAM role"
  type        = string
}

variable "aws_iam_role_policy_cni_policy" {
  description = "ARN of the EKS CNI policy to attach to the IAM role"
  type        = string
}

variable "aws_iam_role_policy_ec2_policy" {
  description = "ARN of the EC2 Container Registry ReadOnly policy to attach to the IAM role"
  type        = string
}
